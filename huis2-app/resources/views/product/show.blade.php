...
<main>
        ...
        <div class="detail__grid">
            <div class="detail__info">
                ...
                <h2>{{ $productHuis->title }}</h2>
                <p>{{ $productHuis->subtitle }}</p>
                <p>{{ $productHuis->city }}</p>
                <p>{{ $productHuis->address }}</p>

                <ul class="detail__mini__list">
                    <li>Vraagprijs: € {{ $productHuis->price }}</li>
                    <li>Totale opp. grond: {{ $productHuis->size }} m²</li>
                </ul>
                </div>
            ...
            <div class="detail__foto">
                <img src="{{ $productHuis->image }}" alt="Woning 1">
            </div>
        </div>
    </div>
