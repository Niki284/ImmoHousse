...
class WoningController extends Controller
{
    ...
    {
        //
        return view('woning.create', ['woningHuis' => Woning::all() , 'woning_types'=>WoningType::all(), 'bouwtypes'=>Bouwtype::all() ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('woning.show', ['woningHuis' => $woningHuis, 'woning_types'=>WoningType::all(), 'bouwtypes'=>Bouwtype::all()]);
    }
