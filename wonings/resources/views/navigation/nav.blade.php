    ...
    <nav class="header__max">
        ...
        <div class="navigation__flex">
           <div class="nav__logo">
            ...
            <ul class="header__top__list header__top__list--richt">
                <li><a href="/">HOME</a></li>
                <li><a href="/woning">TE KOOP</a></li>
                <li><a href="/woning">TE HUUR</a></li>
                <li><a href="/woning">NIEUW BOUW</a></li>
                <li><a href="/woning">MIJN FAVORIRE</a></li>
            </ul> 
